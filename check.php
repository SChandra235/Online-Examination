...
@keyframes leelaanimate{
   ...
   <body>
     <div class="container text-center" >
     	<br><br>
    	<h1 class="text-center text-success text-uppercase animateuse" >  Presidency University Entrance Test (PUEE) </h1>
    	<br><br><br><br>
  ...
  -->
            ...
            <?php 
            $name = $_SESSION['ac'];
            $finalresult = " insert into student values ('$name','3','$Resultans') ";
